...
export const SEED_ELITE_AFFIXES: EliteAffixDefinition[] = [
  { id: 'shielded', name: 'Shielded', hpMult: 1.15, shieldFraction: 0.45, auraColor: '#38bdf8', enabled: true },
  { id: 'volatile', name: 'Volatile', hpMult: 1.0, onDeathExplosion: { radius: 6, damage: 35 }, auraColor: '#f97316', enabled: true },
  { id: 'swift', name: 'Swift', speedMult: 1.35, hpMult: 0.9, auraColor: '#a3e635', enabled: true },
