...
export const FOLLOWER_SEED: PathFollowerDef[] = [
  {
    id: 'fol_npc_walker', name: 'Walker', areaId: 'rescue_hq', kind: 'npc', pathId: 'path_test_straight',
  ...
  {
    id: 'fol_vehicle_convoy', name: 'Convoy', areaId: 'rescue_hq', kind: 'vehicle', pathId: 'path_test_curve',
