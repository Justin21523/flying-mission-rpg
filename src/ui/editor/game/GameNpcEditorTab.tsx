...
// Compact multi-select checkbox grid (mission links etc).
const MultiCheck = ({ label, options, selected, onChange }: { label: string; options: { id: string; label: string }[]; selected: string[]; onChange: (ids: string[]) => void }) => {
