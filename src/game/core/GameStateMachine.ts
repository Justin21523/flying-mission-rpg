...
export const TRANSITIONS: Record<GamePhase, GamePhase[]> = {
  ...
  DESCENT: ['LANDING'],
  LANDING: ['NPC_GREETING', 'ADVANCED_MISSION_ZONE'],
  NPC_GREETING: ['MISSION_GAMEPLAY'],
  MISSION_GAMEPLAY: ['SUPPORT_SELECTION', 'MISSION_COMPLETE', 'HANGAR'],
  ADVANCED_MISSION_ZONE: ['ZONE_SEGMENT_GAMEPLAY', 'NPC_GREETING'], // NPC = safety fallback if a zone fails to load
  ZONE_SEGMENT_GAMEPLAY: ['ZONE_COMPLETE', 'MISSION_COMPLETE', 'SUPPORT_SELECTION', 'HANGAR'],
  ZONE_COMPLETE: ['ZONE_SEGMENT_GAMEPLAY', 'MISSION_COMPLETE'],
  SUPPORT_SELECTION: ['MISSION_GAMEPLAY', 'ZONE_SEGMENT_GAMEPLAY', 'HANGAR'],
